...
class OpenapiGetAccettazioneConsegnaResponse
{
    ...
    /**
     * @param array{
     *   data: array<int, array{sender: string, recipient: string, date: string, object: string, message: string}|ResponseStatus>,
     *   success: bool,
     *   message: string
     * } $data
     */
    ...
    /**
     * @return array{
     *   data: array<int, array{sender: string, recipient: string, date: string, object: string, message: string}>,
     *   success: bool,
     *   message: string
     * }
     */
